...
describe('ShadowsocksManagerService', () => {
    ...
    describe('getServer', () => {
        it('Return default name if name is absent', (done) => {
            ...
            const service = new manager_service_1.ShadowsocksManagerService('default name', serverConfig, repo, null, null);
    ...
    describe('listAccessKeys', () => {
        it('lists access keys in order', (done) => {
            const repo = new mocks_1.MockAccessKeyRepository();
            const service = new manager_service_1.ShadowsocksManagerService('default name', null, repo, null, null);
    ...
    describe('getShareMetrics', () => {
        it('Returns value from sharedMetrics', (done) => {
            ...
            const service = new manager_service_1.ShadowsocksManagerService('default name', null, null, null, sharedMetrics);
...
function fakeSharedMetricsReporter() {
    let sharing = false;
    return {
        startSharing() {
            sharing = true;
