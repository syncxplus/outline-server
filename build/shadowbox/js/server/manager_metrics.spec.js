...
describe('ManagerMetrics', () => {
    it('Saves traffic to config', (done) => {
        ...
        const metrics = new manager_metrics_1.ManagerMetrics(clock, config);
        ...
        expect(new manager_metrics_1.ManagerMetrics(clock, new json_config_1.InMemoryConfig(config.mostRecentWrite))
